...
from mmyolo.models.layers.yolo_bricks import CSPLayer_Ghostv2_conv, CSPLayer_Ghostv2_split_channel, CSPLayerCustom, CSPLayerG, GhostModuleV2
...
class YOLOv5CSPDarknet(BaseBackbone):
    ...
    Example:
        ...
        ...     logger.info(tuple(level_out.shape))
        ...
        (1, 256, 52, 52)
        (1, 512, 26, 26)
        (1, 1024, 13, 13)
...
@MODELS.register_module()
class YOLOXCSPDarknetMY(BaseBackbone):
    # CSP-Darknet backbone used in YOLOX.
